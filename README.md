...
### Latest — 1.2.0
- 288 pals with correct Palpedia numbers
- All pal icons offline
- Breeding shows `#dex` under names

### 1.1.0
- Navigation redesign, full items/bosses, locale fix, crash-on-launch fix
...
- [ ] Play Store / GitHub Releases signed APKs
