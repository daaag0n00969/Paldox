...
EXAMPLE_PALS_BY_TYPE = {
    ...
    "Electric": [("Orserk", "Орсерк"), ("Grizzbolt", "Гризболт"), ("Dynamoff", "Динамофф")],
    "Ice": [("Frostallion", "Фросталлион"), ("Bastigor", "Бастигор"), ("Cryolinx", "Криолинкс")],
    "Ground": [("Anubis", "Анубис"), ("Aegidron", "Эгидрон"), ("Knocklem", "Бронебол")],
    ...
    "Neutral": [("Paladius", "Паладиус"), ("Knocklem", "Бронебол"), ("Kingpaca", "Кингпака")],
}
