        ...
        palDao.insertAll(
            seed.pals.map { p ->
                PalEntity(
                    ...
                    strongElementsCsv = p.strongElements.joinToString(","),
                    weakToElementsCsv = p.weakToElements.joinToString(","),
                    strongVsPalIdsCsv = p.strongVsPalIds.joinToString(","),
                    weakToPalIdsCsv = p.weakToPalIds.joinToString(","),
                    dropItemIdsCsv = p.dropItemIds.joinToString(","),
